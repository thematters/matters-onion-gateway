...
const messages = {
  [LANG_ZH_HANT]: {
    ...
    comments: '留言',
    commentsReadOnly: '唯讀顯示，留言請至 Matters 主站。',
    commentsTruncated: (shown, total) => `顯示前 ${shown} 則，共 ${total} 則留言。`,
    noComments: '目前沒有留言。',
  ...
  [LANG_ZH_HANS]: {
    ...
    comments: '留言',
    commentsReadOnly: '只读显示，留言请至 Matters 主站。',
    commentsTruncated: (shown, total) => `显示前 ${shown} 则，共 ${total} 则留言。`,
    noComments: '目前没有留言。',
  ...
  [LANG_EN]: {
    ...
    comments: 'Comments',
    commentsReadOnly: 'Read-only. To comment, visit Matters.',
    commentsTruncated: (shown, total) => `Showing the first ${shown} of ${total} comments.`,
