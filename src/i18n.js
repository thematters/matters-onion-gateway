...
const messages = {
  [LANG_ZH_HANT]: {
    ...
    discover: '探索',
    discoverExamples: ['mashbean', '自由寫', 'Matters Lab', 'https://matters.town/a/...', 'bafy...'],
    home: '首頁',
  ...
  [LANG_ZH_HANS]: {
    ...
    discover: '探索',
    discoverExamples: ['mashbean', '自由写', 'Matters Lab', 'https://matters.town/a/...', 'bafy...'],
    home: '首页',
  ...
  [LANG_EN]: {
    ...
    discover: 'Explore',
    discoverExamples: ['mashbean', 'Freewrite', 'Matters Lab', 'https://matters.town/a/...', 'bafy...'],
    home: 'Home',
